...
enum sa_opcode
{
    ...
    SA_OPCODE_WINDOW_SCALE_CUSTOM   = 0x14,
    SA_OPCODE_WINDOW_LOCKEDBOUNDS_ANIMATE   = 0x15,
    SA_OPCODE_WINDOW_LOCKEDBOUNDS_CLEAR     = 0x16,
    SA_OPCODE_WINDOW_LOCKEDBOUNDS_BATCH     = 0x17,
    SA_OPCODE_WINDOW_ANIMATE_FRAME  = 0x18,
};
