...
extern void SLSManagedDisplayIteratorGetUUIDBytes(CFTypeRef iterator, uint8_t uuid_bytes[16]);
extern CFArrayRef SLSManagedDisplayIteratorCopyRoleWindows(CFTypeRef iterator);
extern CFArrayRef SLSManagedDisplayIteratorCopyManagedSpaces(CFTypeRef iterator);
